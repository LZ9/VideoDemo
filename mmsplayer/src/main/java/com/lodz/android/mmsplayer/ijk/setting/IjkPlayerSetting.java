...
public class IjkPlayerSetting {
    ...
    public static IjkPlayerSetting getDefault(){
        ...
        setting.isUsingMediaCodec = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH;
...
//--------------------------- 硬解码设置 -----------------------------------
    /** 是否使用硬解码 */
    public boolean isUsingMediaCodec = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH;
    /** 是否使用硬解码下自动旋转 */
